...
- (ZMTextJson*) textJson {
  return resultGenericMessage.textJson;
}
- (ZMGenericMessageBuilder*) setTextJson:(ZMTextJson*) value {
  resultGenericMessage.hasTextJson = YES;
  resultGenericMessage.textJson = value;
  return self;
}
- (ZMGenericMessageBuilder*) setTextJsonBuilder:(ZMTextJsonBuilder*) builderForValue {
  return [self setTextJson:[builderForValue build]];
}
- (ZMGenericMessageBuilder*) mergeTextJson:(ZMTextJson*) value {
  if (resultGenericMessage.hasTextJson &&
      resultGenericMessage.textJson != [ZMTextJson defaultInstance]) {
    resultGenericMessage.textJson =
      [[[ZMTextJson builderWithPrototype:resultGenericMessage.textJson] mergeFrom:value] buildPartial];
  } else {
    resultGenericMessage.textJson = value;
  }
  resultGenericMessage.hasTextJson = YES;
...
@interface ZMTextJson ()
@property (strong) NSString* content;
@end

@implementation ZMTextJson
...
static ZMTextJson* defaultZMTextJsonInstance = nil;
+ (void) initialize {
  if (self == [ZMTextJson class]) {
    defaultZMTextJsonInstance = [[ZMTextJson alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultZMTextJsonInstance;
}
- (instancetype) defaultInstance {
  return defaultZMTextJsonInstance;
}
...
+ (ZMTextJson*) parseFromData:(NSData*) data {
  return (ZMTextJson*)[[[ZMTextJson builder] mergeFromData:data] build];
}
+ (ZMTextJson*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (ZMTextJson*)[[[ZMTextJson builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (ZMTextJson*) parseFromInputStream:(NSInputStream*) input {
  return (ZMTextJson*)[[[ZMTextJson builder] mergeFromInputStream:input] build];
}
+ (ZMTextJson*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (ZMTextJson*)[[[ZMTextJson builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (ZMTextJson*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (ZMTextJson*)[[[ZMTextJson builder] mergeFromCodedInputStream:input] build];
}
+ (ZMTextJson*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (ZMTextJson*)[[[ZMTextJson builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (ZMTextJsonBuilder*) builder {
  return [[ZMTextJsonBuilder alloc] init];
}
+ (ZMTextJsonBuilder*) builderWithPrototype:(ZMTextJson*) prototype {
  return [[ZMTextJson builder] mergeFrom:prototype];
}
- (ZMTextJsonBuilder*) builder {
  return [ZMTextJson builder];
}
- (ZMTextJsonBuilder*) toBuilder {
  return [ZMTextJson builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasContent) {
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[ZMTextJson class]]) {
    return NO;
  }
  ZMTextJson *otherMessage = other;
  return
...
@interface ZMTextJsonBuilder()
@property (strong) ZMTextJson* resultTextJson;
@end

@implementation ZMTextJsonBuilder
@synthesize resultTextJson;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultTextJson = [[ZMTextJson alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (ZMTextJsonBuilder*) clone {
  return [ZMTextJson builderWithPrototype:resultTextJson];
}
- (ZMTextJson*) defaultInstance {
  return [ZMTextJson defaultInstance];
}
- (ZMTextJson*) build {
  [self checkInitialized];
  return [self buildPartial];
...
- (ZMTextJson*) buildPartial {
  ZMTextJson* returnMe = resultTextJson;
  self.resultTextJson = nil;
  return returnMe;
}
- (ZMTextJsonBuilder*) mergeFrom:(ZMTextJson*) other {
  if (other == [ZMTextJson defaultInstance]) {
    return self;
  }
  if (other.hasContent) {
...
- (BOOL) hasContent {
  return resultTextJson.hasContent;
}
- (NSString*) content {
  return resultTextJson.content;
}
- (ZMTextJsonBuilder*) setContent:(NSString*) value {
  resultTextJson.hasContent = YES;
  resultTextJson.content = value;
  return self;
}
- (ZMTextJsonBuilder*) clearContent {
  resultTextJson.hasContent = NO;
  resultTextJson.content = @"";
  return self;
}
@end
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasQuote) {
    [output writeMessage:100 value:self.quote];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (SInt32) serializedSize {
  ...
  if (self.hasQuote) {
    size_ += computeMessageSize(100, self.quote);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (BOOL) hasQuote {
  return resultImageAsset.hasQuote;
}
- (ZMQuote*) quote {
  return resultImageAsset.quote;
}
- (ZMImageAssetBuilder*) setQuote:(ZMQuote*) value {
  resultImageAsset.hasQuote = YES;
  resultImageAsset.quote = value;
  return self;
}
...
- (ZMImageAssetBuilder*) mergeQuote:(ZMQuote*) value {
  if (resultImageAsset.hasQuote &&
      resultImageAsset.quote != [ZMQuote defaultInstance]) {
    resultImageAsset.quote =
      [[[ZMQuote builderWithPrototype:resultImageAsset.quote] mergeFrom:value] buildPartial];
  } else {
    resultImageAsset.quote = value;
  }
  resultImageAsset.hasQuote = YES;
...
- (BOOL) hasQuote {
  return resultOriginal.hasQuote;
}
- (ZMQuote*) quote {
  return resultOriginal.quote;
}
- (ZMAssetOriginalBuilder*) setQuote:(ZMQuote*) value {
  resultOriginal.hasQuote = YES;
  resultOriginal.quote = value;
  return self;
}
...
- (ZMAssetOriginalBuilder*) mergeQuote:(ZMQuote*) value {
  if (resultOriginal.hasQuote &&
      resultOriginal.quote != [ZMQuote defaultInstance]) {
    resultOriginal.quote =
      [[[ZMQuote builderWithPrototype:resultOriginal.quote] mergeFrom:value] buildPartial];
  } else {
    resultOriginal.quote = value;
  }
  resultOriginal.hasQuote = YES;
