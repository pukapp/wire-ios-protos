...
public struct NewOtrMessage {
  ...
  public var unblock: Bool {
    get {return _storage._unblock ?? false}
    set {_uniqueStorage()._unblock = newValue}
  }
  /// Returns true if `unblock` has been explicitly set.
  public var hasUnblock: Bool {return _storage._unblock != nil}
  /// Clears the value of `unblock`. Subsequent reads from it will return its default value.
  public mutating func clearUnblock() {_uniqueStorage()._unblock = nil}
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 100: try decoder.decodeSingularBoolField(value: &_storage._unblock)
        default: break
        }
      }
    }
  ...
  public static func ==(lhs: NewOtrMessage, rhs: NewOtrMessage) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._unblock != rhs_storage._unblock {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
